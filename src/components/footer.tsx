        ...
        <footer className="text-white bg-[url('/assets/bg.png')] bg-contain bg-black font-satoshi  mt-14 z-[99999] relative pt-[55px] min-h-[100vh] ">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-between mt-[44px] px-9">
                ...
                <div className="flex flex-col gap-6">
                    <Image
                        src="/assets/gen_study_materials.svg"
                        alt="clark btn"
                        width={460}
                        height={66}
                    />
            ...
            <div className='md:mt-[235px] mt-[50px] relative px-9'>
                <Image src='/assets/clark_icon5.svg' alt='clark icon' width={169} height={151} className='md:w-[169px] w-[100px] absolute left-0 top-0' />
