...
const Collab = () => {
  ...
  return (
    <section
      className="mt-[124px] relative px-3 md:px-0 font-satoshi flex flex-col items-center bg-[url('/assets/bg.png')] bg-contain cursor-none"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Header Icons */}
      <div className="flex justify-between w-full items-center px-[29px] pt-[30px]">
        <Image src="/assets/clarkbtn.svg" alt="" width={40} height={44} draggable={false} />
        <Image src="/assets/plusmore.svg" alt="" width={51} height={19} draggable={false} />
      </div>

      {/* Main Heading */}
      <div className="md:text-[60px]/[120%] text-[30px] font-semibold font-american flex flex-col items-center">
        <h2>Study Together,</h2>
        <div className="flex">
          <span className="relative">
            Anytime
            <Image src="/assets/line1.svg" alt="" width={255} height={3} className="absolute bottom-1 right-0 left-0" draggable={false} />
          </span>
          ,{" "}
          <span className="relative">
            Anywhere.
            <Image src="/assets/line2.svg" alt="" width={304} height={1} className="absolute bottom-1 right-0 left-0" draggable={false} />
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:mt-[104px] mt-[50px] md:gap-[103px] gap-[50px] md:pb-48 pb-28">
        ...
        <div className="relative mt-[90px]">
          <Image src="/assets/cardd4.svg" alt="" width={324} height={387} draggable={false} />
        ...
        <motion.div transition={{ ease: "easeOut", type: "spring", duration: 0.3, damping: 90 }}
          ...
          <Image src="/assets/cardd3.svg" alt="" width={324} height={387} draggable={false} />
        </motion.div>

        {/* Right Card */}
        <div className="relative mt-[90px]">
          <Image src="/assets/cardd5.svg" alt="" width={324} height={387} draggable={false} />
